...
namespace EShoppy.Finantial_Module
{
    public static class FinantialDB
    {
        ...
        static FinantialDB()
        {
            ...
            ICurrency c1 = new Currency() { Code = "EUR", Name = "Euro", Value = 117.6 };
            ICurrency c2 = new Currency() { Code = "USD", Name = "Americki dolar", Value = 96.68 };
            ICurrency c3 = new Currency() { Code = "AUD", Name = "Australijski dolar", Value = 75.85 };
            ICurrency c4 = new Currency() { Code = "KWD", Name = "Kuvajtski dinar", Value = 327.0 };
